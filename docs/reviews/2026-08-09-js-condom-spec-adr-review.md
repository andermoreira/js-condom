# Revisão crítica — Spec e ADR do `js-condom`

**Data:** 2026-08-09

**Artefatos revisados:** `specs/js-condom-core.md`, `adr/001-engine-propria-vs-orquestracao.md` e `benchmark-js-protection.md`
...
> corrente deve ser avaliado junto de `specs/js-condom-polymorphism-poc.md`.
...
21. **[`specs/js-condom-core.md:376`](../../specs/js-condom-core.md) — O estado documental viola a própria sequência do processo.** A spec diz aguardar aprovação “para avançar para ADR”, embora o ADR já exista, e o ADR não declara status, data ou supersessão. Correção: marcar ambos como `Proposed`, realizar os POCs bloqueantes e só então registrar aceite; ADR aceita não deve depender de open questions que podem invalidá-la.

### Baixo

22. **[`specs/js-condom-core.md:256`](../../specs/js-condom-core.md) — O erro runtime “auto-defendendo” não possui código, contrato nem vínculo com o CLI.** Isso contradiz a tabela de erros estáveis e AC11. Correção: definir se é comportamento do código gerado ou da ferramenta, além de tipo, observabilidade e teste próprios.

## O que está bem-feito

- A spec explicita corretamente que ofuscação não é criptografia e que secrets não pertencem ao frontend ([`specs/js-condom-core.md:16`](../../specs/js-condom-core.md), [`specs/js-condom-core.md:69`](../../specs/js-condom-core.md)).
- As limitações de domain lock e self-defending não são escondidas ([`specs/js-condom-core.md:309-311`](../../specs/js-condom-core.md)).
- Seed efetiva no resultado é uma boa base para reprodução, embora ainda falte um manifesto de release ([`specs/js-condom-core.md:156-164`](../../specs/js-condom-core.md)).
